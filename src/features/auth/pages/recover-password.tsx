...
import { Input, Button, StatusModal } from '../../../components/index';
    ...
    return (
        ...
        */}
            <StatusModal
                ...
                type="success"
                title="¡Enlace enviado al correo!"
                buttonText="Hecho"
            />
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 bg-bg-surface relative z-10 rounded-tl-[1vw] rounded-bl-[1vw] transition-colors duration-300">
                <div className="w-full max-w-md flex flex-col items-center">
                    ...
                    <form onSubmit={handleSendLink} className="w-full flex flex-col gap-5 items-center">
                        ...
                        <Button type="submit" className="mt-4" disabled={isLoading} >
                            {isLoading ? 'Confirmando...' : 'Enviar enlace'}
                        </Button>
                        <p>
